...
window.SEMICOLON_notificationInit = function( $notifyEl ){
	...
	let element   = $notifyEl,
		...
		elMsg   = element.attr('data-notify-msg') || 'Mensaje Enviado!',
